...
function makeProps(focusBorderColor, margin, marginTop, marginBottom, marginLeft, marginRight, padding, paddingTop, paddingBottom, paddingLeft, paddingRight, px, py) {
  ...
  return (function (param, param$1, param$2, param$3, param$4, param$5, param$6, param$7, param$8, param$9, param$10, param$11, param$12, param$13) {
      return (function (param$14, param$15, param$16, param$17) {
          var prim = param;
          var prim$1 = param$1;
          var prim$2 = param$2;
          var prim$3 = param$3;
          ...
          if (prim$2 !== undefined) {
            tmp.onChange = Caml_option.valFromOption(prim$2);
          }
          if (prim$3 !== undefined) {
            tmp.onBlur = Caml_option.valFromOption(prim$3);
          }
          if (prim$4 !== undefined) {
          ...
          if (prim$14 !== undefined) {
            tmp.focusBorderColor = Caml_option.valFromOption(prim$14);
          }
          if (prim$15 !== undefined) {
            tmp.margin = Caml_option.valFromOption(prim$15);
          }
          if (prim$16 !== undefined) {
            tmp.marginTop = Caml_option.valFromOption(prim$16);
          }
          if (prim$17 !== undefined) {
            tmp.marginBottom = Caml_option.valFromOption(prim$17);
          }
          if (prim$18 !== undefined) {
            tmp.marginLeft = Caml_option.valFromOption(prim$18);
          }
          if (prim$19 !== undefined) {
            tmp.marginRight = Caml_option.valFromOption(prim$19);
          }
          if (prim$20 !== undefined) {
            tmp.padding = Caml_option.valFromOption(prim$20);
          }
          if (prim$21 !== undefined) {
            tmp.paddingTop = Caml_option.valFromOption(prim$21);
          }
          if (prim$22 !== undefined) {
            tmp.paddingBottom = Caml_option.valFromOption(prim$22);
          }
          if (prim$23 !== undefined) {
            tmp.paddingLeft = Caml_option.valFromOption(prim$23);
          }
          if (prim$24 !== undefined) {
            tmp.paddingRight = Caml_option.valFromOption(prim$24);
          }
          if (prim$25 !== undefined) {
            tmp.px = Caml_option.valFromOption(prim$25);
          }
          if (prim$26 !== undefined) {
            tmp.py = Caml_option.valFromOption(prim$26);
          }
          if (prim$27 !== undefined) {
            tmp.size = (function () {
                  switch (Caml_option.valFromOption(prim$27)) {
                    case 25754 : 
                        return "sm";
                    case 24407 : 
                        return "md";
          ...
          if (prim$29 !== undefined) {
            tmp.key = Caml_option.valFromOption(prim$29);
          }
          return tmp;
        });
    });
