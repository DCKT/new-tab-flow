  ...
  return (function (param) {
      return (function (param$1, param$2, param$3) {
          return (function (param$4, param$5) {
              ...
              var prim$8 = param$13;
              var prim$9 = param$14;
              var prim$10 = param$15;
              var tmp = {
                children: prim
              };
              if (prim$1 !== undefined) {
                tmp.isTruncated = Caml_option.valFromOption(prim$1);
              }
              if (prim$2 !== undefined) {
                tmp.textAlign = Caml_option.valFromOption(prim$2);
              }
              if (prim$3 !== undefined) {
                tmp.as = (function () {
              ...
              if (prim$5 !== undefined) {
                tmp.font = Caml_option.valFromOption(prim$5);
              }
              if (prim$6 !== undefined) {
                tmp.letterSpacing = Caml_option.valFromOption(prim$6);
              }
              if (prim$7 !== undefined) {
                tmp.lineHeight = Caml_option.valFromOption(prim$7);
              }
              if (prim$8 !== undefined) {
                tmp.fontSize = Caml_option.valFromOption(prim$8);
              }
              if (prim$9 !== undefined) {
                tmp.color = Caml_option.valFromOption(prim$9);
              }
